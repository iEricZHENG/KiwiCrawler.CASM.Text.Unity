...
namespace FormKiwiCrawler
{
    public partial class frmAdd : Form
    {
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            //urlFrmMode.kDetailPatternType = cbDetailPatternType.Text.Trim();//原来存储的详细页类型，改为组号
            urlFrmMode.kRegularGroupNum = txtGroupNum.Text.Trim();
            ...
            if (urlFrmMode.kNextPagePatternType=="正则表达式")
            {
                urlFrmMode.kNextPageRegularGroupNum = Convert.ToInt32(this.txtNextGroupNum.Text.Trim());
            }            
            string msg = "";
            //保存到数据库
